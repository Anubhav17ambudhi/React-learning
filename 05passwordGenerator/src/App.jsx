  ...
  return (
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-10 text-orange-500 bg-gray-700'>
        <h1 className='text-white text-center my-3 mb-3'>Password Generator</h1>
        <div className='flex shadow rounded-lg overflow-hidden mb-8'>
          ...
          className='outline-none bg-blue-700 text-white px-3 py-3 mb-4 shrink-0 rounded-lg'>copy</button>
        </div>
